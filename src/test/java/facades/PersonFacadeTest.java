...
//        Clean up database after test is done or use a persistence unit with drop-and-create to start up clean on every test
    ...
    public void setUp() {
        ...
        p1 = new Person("Mads", "Mikkelsen", "66699911");
        p1.setAddress(new Address("Skuespillergade 9","3460","Birkebronx"));
        p2 = new Person("Lars", "Mikkelsen", "99966611");
        p2.setAddress(new Address("Starwarsgade 17", "2130","Brøndshøj"));
        p3 = new Person("Mor", "Mikkelsen", "11666999");
        p3.setAddress(new Address("Hamburger Strasse","82828","Hamburd"));
...
//        Remove any data after each test was run
    ...
    public void testAddPerson() throws Exception {
        ...
        String lName = "Hansen";
        String phone = "112";
        String street = "Boulevard Rd";
        String zip = "8008";
        String city = "Pyongyang";
        EntityManagerFactory _emf = null;
        PersonFacade instance = PersonFacade.getFacadeExample(_emf);
